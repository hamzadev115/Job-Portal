        ...
        <div class="hero">
            <div class="form-box">
                ...
                <form id="login-form" method="post">
                    <center><u style="color: #51be81;"><p style="color: #51be81;">Job Seeker</p></u></center>
                    
                    
                                <div class="field-gorup" style="margin-top:20px;">
                                    <input type="text" autocomplete="off" name="em" class="in2" placeholder="Enter Email" >
                                ...
                                <div class="field-gorup" style="margin-top:20px;">
                                    <input type="password" autocomplete="off" name="pa" class="in2" placeholder="Enter Password" >
                                    <div class="icon" style="border-right:1px solid #51be81;height:30px">
                                ...
                                <div class="field-gorup" style="margin-top:30px;">
                                    <input type="submit" name="user-login" class="in3" value="Login"  >
                                    
                                    </div>
                                    <center> <ul class="already mb-3">
...
elseif($pa==""){
    ...
    $query="SELECT * FROM `user-register` WHERE email='".$em."' and password='".$pa."'";
    ...
    echo "<div class='alert alert-success mt-3 ' style='margin-left:100px;margin-right:100px'  > This Email is Not Registered</div>";
...
?>
                ...
                <center><u><p>Employer</p></u></center>
                    <div class="field-gorup" >
                        <input type="text" autocomplete="off" name="na1" class="in2" placeholder="Enter Organization Name">
                        <div class="icon" style="border-right:1px solid #51be81;height:30px">
                    ...
                    <div class="field-gorup" style="margin-top:20px;">
                                    <input type="text" autocomplete="off" name="em1" class="in2" placeholder="Enter Organization Email" >
                                    <div class="icon" style="border-right:1px solid #51be81;height:30px">
                                     <i class="fa fa-envelope" style="font-size:20px"   aria-hidden="true"></i>
                                    </div>
                                </div>
                                ...
                                <div class="field-gorup" style="margin-top:25px;">
                                    <input type="password" autocomplete="off" name="pa1" class="in2" placeholder="Enter Password" >
                                    <div class="icon" style="border-right:1px solid #51be81;height:30px">
                                     <i class="fa fa-lock"   aria-hidden="true"></i>
                                    </div>
                                </div>
                                ...
                                <div class="field-gorup" style="margin-top:30px;">
                                    <input type="submit" name="submit" class="in3" value="Login"  >
...
elseif($pa1==""){
    ...
    $query="SELECT * FROM `company-register` WHERE  email='".$em1."' and password='".$pa1."'";
    $run=mysqli_query($conect,$query);
           if (mysqli_num_rows($run)>0) {
