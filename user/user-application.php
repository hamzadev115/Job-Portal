                ...
                <div class="col-lg-8 col-md-12 col-xs-12">
                  ...
                  if ($msg=='') {
                   ...
                   <?php
                    ...
                    echo "<div class='alert alert-success ml-5 mr-5'>you are  <b>selcted</b></div>";
                }  
                 ?>
                  <?php
                      if ($ms1=='') {
                    ...
                    echo "<div class='alert alert-success ml-5 mr-5'>you are not <b>selcted</b></div>";
                }  
                 ?>
        ...
        include('connection.php');
                        ...
                        <div class="manager-resumes-item">
                            ...
                            <div class="update-date">
                                ...
                                <a class="btn btn-xs btn-gray" href="update-japplier.php?id= <?php echo $id ?>">Edit</a>
                                    <a class="btn btn-xs btn-danger" href="delete-japplier.php?id= <?php echo $id ?>">Delete</a>
                                </div>
                            </div>
                        </div>
