                    ...
                    <?php
                        ...
                        <form class="form-ad" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" readonly autocomplete="off"  value="<?php echo $jtitle ?>" name="jtitle" class="form-control" placeholder="Write job title">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Company</label>
                                <input type="text" readonly autocomplete="off"  value="<?php echo $cname ?>" name="cname" class="form-control" placeholder="Write company name">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Location <span>(optional)</span></label>
                                <input type="text" readonly  value="<?php echo $location ?>" autocomplete="off" name="location" class="form-control" placeholder="e.g.Lahore">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Location <span>(optional)</span></label>
                                <input type="text" readonly  value="<?php echo $category ?>" autocomplete="off" name="location" class="form-control" placeholder="e.g.Lahore">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Location <span>(optional)</span></label>
                                <input type="text" readonly  value="<?php echo $time ?>" autocomplete="off" name="location" class="form-control" placeholder="e.g.Lahore">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Post Date </label>
                                <input name="postdate" readonly  value="<?php echo $postdate ?>" autocomplete="off" type="Date" class="form-control" placeholder="Post Date">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Closing Date </label>
                                <input name="closedate" readonly  value="<?php echo $closedate ?>" autocomplete="off" type="Date" class="form-control" placeholder="Closing Date">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Description</label>
                                <textarea name="description" readonly class="form-control" placeholder="Description"  id="" > <?php echo $description ?> </textarea>

                            </div>
                           
                            <div class="form-group">
                                <label class="control-label">Needs For Jobs</label>
                                <textarea name="need" readonly  autocomplete="off" class="form-control" placeholder="Need For Jobs" name="" id="" > <?php echo $need ?> </textarea>
                                
                            </div>
                            <div class="form-group">
                                <label class="control-label">website </label>
                                <input name="website" readonly  value="<?php echo $website ?>" autocomplete="off" type="text" class="form-control" placeholder="website link">
                            </div>
                         
                            <div class="form-group">
                                <label class="control-label">How to Apply</label>
                                <input name="howapply" readonly  value="<?php echo $howapply ?>" autocomplete="off" type="text" class="form-control" placeholder="How to Apply">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Salary </label>
                                <input name="salary" readonly value="<?php echo $salary ?>" autocomplete="off" type="text" class="form-control" placeholder="Salary">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Map URL</label>
                                <input name="map"  readonly value="<?php echo $map ?>" autocomplete="off" type="text" class="form-control" placeholder="Map URL">
                            </div>
                          ...
                          <a href="employe-profile.php">  <input type="btn" readonly name="submit" class="btn btn-common" value="Back" ></a>
